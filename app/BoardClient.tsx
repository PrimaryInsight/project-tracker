...
const stages = [
  { code: "catchup", label: "Meeting" },
  { code: "quote", label: "Quote" },
  { code: "followup", label: "Follow-up" },
  { code: "started", label: "Project Confirmed" },
  { code: "install", label: "Install Planned" },
  { code: "invoiced", label: "To Invoice" },
];
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        {stages.map((stage) => {
          ...
          return (
            <section
              key={stage.code}
              className="min-h-[420px] rounded-lg border bg-white p-3"
            >
